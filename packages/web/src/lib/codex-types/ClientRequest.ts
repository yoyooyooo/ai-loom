...
export type ClientRequest =
  ...
  | { method: 'listConversations'; id: RequestId; params: ListConversationsParams }
  | { method: 'resumeConversation'; id: RequestId; params: ResumeConversationParams }
  | { method: 'archiveConversation'; id: RequestId; params: ArchiveConversationParams }
  | { method: 'sendUserMessage'; id: RequestId; params: SendUserMessageParams }
  | { method: 'sendUserTurn'; id: RequestId; params: SendUserTurnParams }
  | { method: 'interruptConversation'; id: RequestId; params: InterruptConversationParams }
  | { method: 'addConversationListener'; id: RequestId; params: AddConversationListenerParams }
  | {
  ...
  | { method: 'loginApiKey'; id: RequestId; params: LoginApiKeyParams }
  | { method: 'loginChatGpt'; id: RequestId; params: undefined }
  | { method: 'cancelLoginChatGpt'; id: RequestId; params: CancelLoginChatGptParams }
  | { method: 'logoutChatGpt'; id: RequestId; params: undefined }
  | { method: 'getAuthStatus'; id: RequestId; params: GetAuthStatusParams }
  | { method: 'getUserSavedConfig'; id: RequestId; params: undefined }
  | { method: 'setDefaultModel'; id: RequestId; params: SetDefaultModelParams }
